    ...
    <>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {featured.map((p, i) => (
              <div
                key={i}
                className="relative p-8 md:p-10 rounded-lg bg-primary text-primary-foreground border border-secondary/20 flex flex-col hover:border-secondary transition-colors"
              >
      ...
      <Section variant="accent">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-serif mb-10 text-center">Outras temáticas</h2>
          <div className="space-y-4">
            {[
              { tag: "Palestra", title: "Vendas com verdade: vender sem se violentar", icon: Heart },
              { tag: "Palestra", title: "Posicionamento e previsibilidade: estrutura que sustenta", icon: Target },
              { tag: "Palestra", title: "IA e o futuro do trabalho feminino: o que muda amanhã", icon: Bot },
            ].map((item, i) => (
      ...
      <Section>
        <div className="max-w-xl mx-auto text-center">
          <h2 className="text-xl font-serif mb-8">Duração</h2>
          <div className="p-6 bg-card gold-border rounded-lg text-center">
            <h3 className="font-serif text-base mb-1">Palestra</h3>
            <p className="text-sm text-muted-foreground font-sans">45 a 90 minutos de impacto</p>
          </div>
        </div>
      </Section>
      ...
      <Section variant="card">
        <div className="max-w-xl mx-auto text-center">
          <h2 className="text-xl font-serif mb-4">Leve Monike para seu evento</h2>
...
// Simple Heart icon for Vendas com verdade if I forgot to import it
