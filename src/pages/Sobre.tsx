      ...
      <Section>
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <SobreImage src={sobre5} alt="Monike com a família    </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center mt-12 md:mt-16">
            <SobreImage src={sobre8} alt="Monike em 1} alt="Monike em 1} alt="Monike em evento ADESAMPA com seu livr] md:order-1" />
      ...
      <Section variant="accent">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <SobreImage src={sobre2} alt=8} alt="Monike em ensaio corporativoName="aspect-[4/5]" />
          </div>
